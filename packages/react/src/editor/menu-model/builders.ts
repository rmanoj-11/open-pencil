...
import {
  EDIT_MENU_COMMAND_GROUPS, OBJECT_MENU_COMMAND_GROUPS, VIEW_MENU_COMMANDS
...
function commandGroupEntries(commandMenuItem: CommandMenuItem, groups: ReadonlyArray<ReadonlyArray<EditorCommandId>>): MenuEntry[] {
