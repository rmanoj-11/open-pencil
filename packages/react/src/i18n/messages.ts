...
const localeLoaders: Record<Exclude<Locale, 'en'>, () => Promise<{ default: ComponentsJSON }>> = {
  de: () => import('#react/locales/de.json'),
  es: () => import('#react/locales/es.json'),
  fr: () => import('#react/locales/fr.json'),
  it: () => import('#react/locales/it.json'),
  pl: () => import('#react/locales/pl.json'),
  ru: () => import('#react/locales/ru.json'),
  'zh-CN': () => import('#react/locales/zh-CN.json')
}
